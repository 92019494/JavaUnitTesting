...
/**
 *
 * This packer class relies on the box classes toString() method. If this test
 * fails please make sure the box test class passes all it's tests before
 * debugging the packer class
 *
