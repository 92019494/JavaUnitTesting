...
public class Box {
    ...
    /**
     * *
     * @param product enter the product you wish to add if a product can fit in
     * the box it will be added
     */
     ...
     * @param quantity enter the amount of the product you wish to add if the
     * products can fit in the box it will be added
     */
    ...
    /**
     *
     * @return the label which includes the customer, the closest depot, the
     * contents of the box and any warnings for whats inside the box
     */
    ...
    /**
     *
     * @return a boolean based on whether the box contains hazardous items or
     * not
     */
